...
const meatsData = ["Chicken", "Beef", "Lamb", "Pork"];

const allergyData = ["Gluten", "Seafood", "Dairy", "Nuts"];

export default function Survey() {
  const questionData = [
    new Question(meatImage, "What meat do you prefer?", meatsData),
    new Question(leafImage, "What are you allergic to?", allergyData),
  ];
